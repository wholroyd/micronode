...
settings.app = {};
settings.app.port = process.env.OPENSHIFT_NODEJS_PORT || 8080;
settings.app.host = process.env.OPENSHIFT_NODEJS_IP || '127.0.0.1';
...
app.use(require('./controllers/index.js')(app));
app.use(require('./controllers/api/index.js')(app));
app.use(require('./controllers/web/index.js')(app));
